      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-up" style={{ animationDelay: '0.2s' }}>
            Optimize your Google, Meta, and LinkedIn campaigns automatically. 
            Save time, reduce costs, and scale your growth with intelligent AI.
          </p>
          ...
          <div className="animate-fade-up" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="flex items-center justify-center gap-8 md:gap-12 opacity-60">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline text-sm font-medium text-foreground">Google</span>
              </div>
              {/* Meta */}
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline text-sm font-medium text-foreground">Meta</span>
              </div>
              {/* LinkedIn */}
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline text-sm font-medium text-foreground">LinkedIn</span>
              </div>
              {/* ChatGPT */}
              <div className="flex items-center gap-2">
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                ...
                <span className="hidden sm:inline text-sm font-medium text-foreground">ChatGPT</span>
              </div>
            </div>
          </div>
        </div>
